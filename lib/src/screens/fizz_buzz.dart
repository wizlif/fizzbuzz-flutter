...
class _FizzBuzzState extends State<FizzBuzz> {
  ...
  void initState() {
    super.initState();
    _bloc.joinGame();
    _timer = Timer.periodic(Duration(seconds: 5), (Timer t) => _bloc.querySessions());
  }
      ...
      appBar: AppBar(
        title: StreamBuilder<int>(
          ...
          builder: (context, snapshot) {
            return Text(snapshot.hasData ? "FizzBuzz (${snapshot.data})" :"FizzBuzz");
          }
        ),
        centerTitle: true,
      ),
          ...
          children: [
            ...
            Expanded(
              ...
              FlatButton(
                ...
                child: Text("Fizz",style: TextStyle(color: Colors.white),),
                color: Theme.of(context).primaryColor,
                padding: EdgeInsets.symmetric(vertical: 15),
                shape: Shapes.tiled,
              ),
            ...
            Expanded(
              ...
              FlatButton(
                ...
                child: Text("Buzz",style: TextStyle(color: Colors.white),),
                color: Theme.of(context).primaryColor,
                padding: EdgeInsets.symmetric(vertical: 15),
                shape: Shapes.tiled,
              ),
            ...
            Expanded(
              ...
              FlatButton(
                ...
                child: Text("FizzBuzz",style: TextStyle(color: Colors.white),),
                color: Theme.of(context).primaryColor,
                padding: EdgeInsets.symmetric(vertical: 15),
                shape: Shapes.tiled,
              ),
